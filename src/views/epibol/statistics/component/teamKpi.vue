        ...
        <Col span="24" class-name='bgw'>
            <div class="itemBox base-card" >
                <div class="base-card-head">
                    <div class="base-card-operation-head" >人员KPI</div>
                    <div class="base-card-operation-icon" >
                        
                    </div>
                </div>
                <team-echars v-if="objData.data"
                    :objData="objData"
                    :accToken="powerToken"
                    ...
                    :yAxis = "yAxis"
                    :isRoll = "false"
                    :percentage = "'client_pass_rate'"
                    :insidePercentage = "'inside_pass_rate'"
                    :echarsUrl="echarsUrl">
                </team-echars>
                <!-- :yAxis = "yAxis" -->
                <template v-else>
...
<script>
import TeamEchars from "../../../../components/TeamEchars.vue";
...
export default {
    ...
    methods: {
        ...
        getCooperation () {
            var self = this;
            this.echarsUrl = this.GLOBAL.baseRouter+onlyAPI.company_member_kpi;
