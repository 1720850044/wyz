...
<template>
    <div>
        <Row :gutter="30"  >
            <Col span="24" class-name='bgw' id="TenderChart">
                <div class="itemBox base-card" >
                <div class="base-card-head">
                    <div class="base-card-operation-head" >{{$t('companyStatistics.company_WinBid')}}</div>
...
export default {
    ...
    //js 数组去重
        ...
        getDataInfo () {
            var self = this;
            this.echarsUrl = this.GLOBAL.baseRouter+ onlyAPI.company_test_bid;
