    ...
    export default {
        ...
        methods: {
                ...
                setTimeout(() => {
                    this.$guide()
                        ...
                        .onafterchange(({dataset}) => {
                            setTimeout(() => {
                                this.$nextTick(() => {
                                    $("#projectScheduleModal .ivu-modal-wrap")
                                        .removeClass(
                                            "introjs-fixParent"
                                        );
                                });
            ...
            DataFilte (val) {
                ...
                this.MSelect = val;
                let url =
                    _this.GLOBAL.baseRouter + this.$GLOBALAPI.task_page + "&is_contract=" + this.PSelect + "&status=" + this.MSelect;
            ...
            HDataFilte (val) {
                let _this = this;
                this.PSelect = val;
                let url = _this.GLOBAL.baseRouter + this.$GLOBALAPI.task_page + "&is_contract=" + this.PSelect + "&status=" + this.MSelect;
                _this.$axios.get(url).then(msg => {
                    _this.MsgData = msg.data.project;
                });
            },
            ...
            subOk () {
                ...
                let _this = this;
                let url = _this.GLOBAL.baseRouter + this.$GLOBALAPI.task_projectadd;
                let editUrl = _this.GLOBAL.baseRouter + this.$GLOBALAPI.task_projectupdate;
