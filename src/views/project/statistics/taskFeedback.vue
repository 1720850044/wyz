            ...
            <Col span="24" class-name='bgw'>
                <div class="itemBox base-card">
                    <div class="base-card-head">
                        <div class="base-card-operation-head" >任务反馈</div>
                    ...
                    <task-echars v-if="objData.data"
                        ...
                        :accToken="powerToken"
                        :formatter = "'taskFeedback'"
                        :yAxis = "yAxis"
                        :isRoll = "false"
                        :percentage = "'inside_pass'"
                        :insidePercentage = "'outside_pass'"
                        :censusType = "'bar'"
                    ...
                    <!-- <div id='taskPassChart' class="itemBox-chartBox" style="position:relative">
                        <nothink type="project" text="暂无数据" v-if="taskPassData.isNull == true"></nothink>
                    </div> -->
                </div>
            </Col>
        </Row>
