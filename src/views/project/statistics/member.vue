        ...
        <Col span="24" class-name='bgw'>
            <div class="itemBox base-card" >
              <div class="base-card-head">
                <div class="base-card-operation-head" >成员任务用时</div>
                <div class="base-card-operation-icon" ><!--p class="iconfonts icon-shenglve-"></p--></div>
                <div style="clear:both"></div>
              </div>
              <!-- <div class="itemBox-CheckboxGroup">
                <CheckboxGroup v-model="memberTaskTimeData.selectUsers" @on-change="updateChart('memberTaskTime')" >
                    <Checkbox v-for="(item,index) in memberTaskUsers" :label="item" :key='index' ></Checkbox>
                </CheckboxGroup>
              </div>
              <div id='memberTaskTime' class="itemBox-chartBox" style="position:relative">
                <nothink type="project" text="暂无数据" v-if="memberTaskTimeData.isNull == true"></nothink>
              </div> -->
