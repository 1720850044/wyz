      ...
      methods: {
          ...
          wrapClick (e) {
              ...
              if (this.isRange && this.tooltipMerge) {
                  ...
                  this.$emit('drag-end', this); //by Song
              }
          },
...
<style>
  ...
  .vue-slider-component .vue-slider-dot .vue-slider-dot-handle {
    ...
    box-shadow: 0.5px 0.5px 2px 1px rgba(244, 244, 244, 0.32);
    background: url('../../assets/images/dot-handle.png') 0 0  no-repeat !important ;
