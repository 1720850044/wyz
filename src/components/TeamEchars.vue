    ...
    methods: {
        ...
        axiosRender () {
            ...
            if(this.censusType == 'heap'){
                var param = {
                    'post_id': self.model2 == 0 ? null : self.model2,
        ...
        handleArr (oldArr,key) {
            oldArr.forEach((val,index) => {
                val[key] = Array.from(oldArr,(x) => x[key]+'%')[index];
            })
        },
        ...
        seriesInstall () {
            ...
            for(var i=0;i<this.newEcharsArr.length;i++){
                if(this.censusType == 'heap'){
                    if(i < this.newEcharsArr.length-2){
                        this.series.push(
                            {
                                name: this.arr[i],
                                type: 'bar',
                    ...
                    tooltip: {
                        ...
                        formatter:function(param){
                            ...
                            for(var i=0;i<param.length;i++){
                                if(self.formatter == '人员KPI' || self.formatter == '人员Time'){
                                    if(i >= 2){
