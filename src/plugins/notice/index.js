...
// 默认是出现在中间
// 全局引入组件
import chatInterface from '@/views/chatInterface/main.vue';
...
exports.install = ((Vue, options) => {
    // 封装公共组件
    Vue.component('chatInterface', chatInterface);
    Vue.component('nothink', Nothing);
    Vue.component('loading', loading);
    Vue.component('previewlist', previewList);
    Vue.component('customerService', customerService);
    Vue.component('routerlink', routerLink);
    Vue.prototype.ymWindow = (_object => {
    ...
    Vue.prototype.ymNotice = (_objects => {
        var className = '';
        var remindText = '';
        var messageRight = '';
        var imgClass = ''; // 显示图标所用
